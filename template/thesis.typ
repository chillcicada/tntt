...
#figure(image("media/logo.jpg", width: 50%), caption: [图片测试]) <logo>
...
#figure(image("media/logo.jpg", width: 20%), caption: [图片测试]) <appendix-img>
...
#acknowledge[
  ...
  感谢#link("https://github.com/Myriad-Dreamin")[纸叶#text(mask-text("姐姐"), font: use-cjk-fonts("SongTi"))]开发的 #link("https://github.com/Myriad-Dreamin/tinymist")[Tinymist] 工具。
